...
class llc(packet_base.PacketBase):
    """LLC(IEEE 802.2) encoder/decoder class.
    ...
    CONTROL_FORMAT_I = 0b0
    CONTROL_FORMAT_S = 0b01
    CONTROL_FORMAT_U = 0b11
    ...
    def _get_control(cls, buf):
        key = buf & 0b1 if buf & 0b1 == cls.CONTROL_FORMAT_I else buf & 0b11
